...
/*
 * التوجيه التلقائي إلى متجر التطبيقات أُزيل عمدًا.
 *
 * كان أي رابط يُفتح من هاتف — رابط مركز، بيان رسمي، طلب إغاثة مشترَك في
 * مجموعة — يُقذف بالزائر إلى صفحة المتجر بدل المحتوى المطلوب، وهو أسوأ ما يمكن
 * أن يحدث لرابط يُتداول أثناء كارثة. روابط التحميل موجودة الآن في التذييل
 * (siteConfig.appStoreUrl / playStoreUrl) يختارها المستخدم متى شاء.
 */
